...
close;
P.P_BE_Ex(i) = PDF_e_temp(bar+ Mr +1)/sum(PDF_e_temp(1: (bar+Mr+1)));
P.P_GE_Ex(i) = PDF_e_temp( M+ Mr)/sum(PDF_e_temp(bar+Mr+2: M+Mr+1));
P.P_BE_E(i) = sum(PDF_e_temp((bar+Mr+1-s_ee+1):bar+Mr+1))/sum(PDF_e_temp(1:bar+Mr+1));
end
...
P.P_BI_Ex(i) = PDF_i_temp(bar+ Mr +1)/sum(PDF_i_temp(1: (bar + Mr + 1)));
P.P_GI_Ex(i) = PDF_i_temp(Mr+M)/sum(PDF_i_temp(bar+Mr+2: Mr+M+1));
P.P_BI_E(i) = sum(PDF_i_temp((bar+Mr+1-s_ie+1): bar+Mr+1))/sum(PDF_i_temp(1:bar+Mr+1));
P.P_GI_E(i) = sum(PDF_i_temp((M+Mr+1-s_ie+1):M+Mr+1))/sum(PDF_i_temp(bar+Mr+2:M+Mr+1));
